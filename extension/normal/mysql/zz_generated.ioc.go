...
type gORMDB_ struct {
	Session_         func(config *gorm.Session) GORMDBIOCInterface
	...
	Scopes_          func(funcs ...func(db *gorm.DB) *gorm.DB) GORMDBIOCInterface
	...
	FindInBatches_   func(dest interface{}, batchSize int, fc func(tx *gorm.DB, batch int) error) GORMDBIOCInterface
...
func (g *gORMDB_) Session(config *gorm.Session) GORMDBIOCInterface {
...
func (g *gORMDB_) Use(plugin gorm.Plugin) error {
	return g.Use_(plugin)
}
func (g *gORMDB_) ToSQL(queryFn func(tx *gorm.DB) *gorm.DB) string {
...
func (g *gORMDB_) Scopes(funcs ...func(db *gorm.DB) *gorm.DB) GORMDBIOCInterface {
...
func (g *gORMDB_) FindInBatches(dest interface{}, batchSize int, fc func(tx *gorm.DB, batch int) error) GORMDBIOCInterface {
...
func (g *gORMDB_) Connection(fc func(db *gorm.DB) error) (err error) {
	return g.Connection_(fc)
}
func (g *gORMDB_) Transaction(fc func(db *gorm.DB) error, opts ...*sql.TxOptions) (err error) {
...
func (g *gORMDB_) Migrator() gorm.Migrator {
	return g.Migrator_()
}
func (g *gORMDB_) AutoMigrate(dst ...interface{}) error {
	return g.AutoMigrate_(dst...)
}
func (g *gORMDB_) Association(column string) *gorm.Association {
	return g.Association_(column)
}

type GORMDBIOCInterface interface {
	Session(config *gorm.Session) GORMDBIOCInterface
	...
	Scopes(funcs ...func(db *gorm.DB) *gorm.DB) GORMDBIOCInterface
	...
	FindInBatches(dest interface{}, batchSize int, fc func(tx *gorm.DB, batch int) error) GORMDBIOCInterface
...
func GetGORMDB(p *Config) (*GORMDB, error) {
...
func GetGORMDBIOCInterface(p *Config) (GORMDBIOCInterface, error) {
