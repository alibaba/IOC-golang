...
func (_m *ParamLoader) Load(sd *autowire.StructDescriptor, fi *autowire.FieldInfo) (interface{}, error) {
	...
	var r0 interface{}
	if rf, ok := ret.Get(0).(func(*autowire.StructDescriptor, *autowire.FieldInfo) interface{}); ok {
		r0 = rf(sd, fi)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*autowire.StructDescriptor, *autowire.FieldInfo) error); ok {
		r1 = rf(sd, fi)
	} else {
		r1 = ret.Error(1)
	}
